...
#define LOG_TAG "lyn-ffmpeg-android-tutorial01"
...
void SaveFrame(JNIEnv *pEnv, jobject pObj, jobject pBitmap, int width, int height, int iFrame) {
	...
	jclass mainActCls;
	sprintf(szFilename, "/sdcard/lyn-ffmpeg-android-tutorial01/frame%d.jpg", iFrame);
...
jint JNI_OnLoad(JavaVM* pVm, void* reserved) {
	...
	nm[0].name = "naMain";
	nm[0].signature = "(Llyn/android_ffmpeg/tutorial01/MainActivity;Ljava/lang/String;I)I";
	nm[0].fnPtr = (void*)naMain;
	jclass cls = (*env)->FindClass(env, "lyn/android_ffmpeg/tutorial01/MainActivity");
