...
int grabdesktop(cmdArgsPtr args)
{
    ...
    if (avformat_open_input
        (&pFormatCtx, "video=screen-capture-recorder", ifmt, NULL) != 0) {
    ...
    int screen_w = 1920 / 2, screen_h = 1080 / 2;
                ...
                if (packet->stream_index == videoindex) {
                    ...
                    if (got_picture) {
                        ...
                        sws_scale(img_convert_ctx,
                                  (const unsigned char *const *) pFrame->
